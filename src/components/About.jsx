...
const About = () => {
  return (
    <section className="about section" id="about">
      <h2 className="section__title">About <span>Us</span></h2>
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          <p className="about__description">
            We are passionate creative designer and art director specializing in UI/UX design, visual identities, and interactive web experiences. With over {personalInfo.experienceYears} of practice delivering solutions for startups and Fortune 7 companies, I merge user empathy with high-end aesthetic precision.
          </p>
